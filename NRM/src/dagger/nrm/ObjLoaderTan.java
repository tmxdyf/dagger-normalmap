...
//Object loader by Stefan Wagner
...
public class ObjLoaderTan {
	static public Mesh loadObj(InputStream in) {
	      String line = "";
	        ...
	        return loadObjFromStringTanBiTan(line);
	      
	   }
	   
	   public static Mesh loadObjFromStringTanBiTan (String obj) {
	        String[] lines = obj.split("\n");
	        float[] vertices = new float[lines.length * 3];
	        float[] normals = new float[lines.length * 3];
	        float[] uv = new float[lines.length * 3];
	        float[] tangents = new float[lines.length * 3];
	        float[] bitangents = new float[lines.length * 3];
	        ...
	        int[] facesTangent = new int[lines.length * 3];
	        int[] facesBitangent = new int[lines.length * 3];
	        int vertexIndex = 0;
	        int normalIndex = 0;
	        int uvIndex = 0;
	        int tangentIndex = 0;
