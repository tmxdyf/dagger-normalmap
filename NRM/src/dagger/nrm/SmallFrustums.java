...
public class SmallFrustums {
	...
	public void setFrustums(PerspectiveCamera cam) {
		...
		ndw.set(nearBotRight).sub(nearBotLeft).div(sizex);
		ndh.set(nearTopLeft).sub(nearBotLeft).div(sizey);
		fdw.set(farBotRight).sub(farBotLeft).div(sizex);
		fdh.set(farTopRight).sub(farBotRight).div(sizey);
